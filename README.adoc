...
image::https://maven-badges.herokuapp.com/maven-central/com.toomuchcoding/jsonassert/badge.svg?style=plastic[Maven Central, link="https://maven-badges.herokuapp.com/maven-central/com.toomuchcoding/jsonassert"]
